...
from autotrader.brokers.quantumhedge import Broker as QuantumHedgeBroker
...
class AutoTrader:
    ...
    def __init__(self) -> None:
        ...
        self._environment: Literal["paper", "live"] = "live"  # Trading environment
    ...
    def run(self) -> Union[None, Broker, VirtualBroker, CCXTBroker, QuantumHedgeBroker]:
        ...
        if self._optimise_mode:
            ...
            if sum([self._backtest_mode, self._scan_mode, self._papertrading]) == 0:
                ...
                # Check broker
                supported_exchanges = ["virtual", "oanda", "ib", "ccxt", "dydx", "quantumhedge"]
