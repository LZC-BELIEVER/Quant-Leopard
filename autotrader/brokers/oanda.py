...
class Broker(Broker):
    def __init__(self, config: dict):
        print("config:",config)
        """Create v20 context."""
        global_config=config["global_config"]["OANDA"]
        ...
        '''
        print("glo_config:",global_config)
        self.API = global_config["API"]
        self.ACCESS_TOKEN = global_config["ACCESS_TOKEN"]
        self.port = global_config["PORT"]
        self.ACCOUNT_ID = global_config["ACCOUNT_ID"]
